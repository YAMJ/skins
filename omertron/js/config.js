 ...
 //*****************************************************************************************   
		...
		function get_poster_number()
			{
				var jsonPosterNbUrl = "http://localhost:8888/yamj3/api/config/list.json?config=skin_index_row";
		...
		{
				var jsonPosterNbUrl = "http://localhost:8888/yamj3/api/config/update.json?key=skin_index_row&value="+row+"";
				console.log("jsonPosterNbUrl: " + jsonPosterNbUrl);
				$.ajax({
                   url: jsonPosterNbUrl,
                    async: false,
